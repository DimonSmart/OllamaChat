...
public sealed class ForceLastUserReducer(ILogger<ForceLastUserReducer>? logger = null) : IChatHistoryReducer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        logger?.LogDebug("ForceLastUserReducer processing {OriginalCount} messages ({FilteredCount} after filtering empty)", 
        ...
        logger?.LogDebug("ForceLastUserReducer last message: Role={LastRole}, Content='{LastContent}', AuthorName='{AuthorName}'", 
        ...
        logger?.LogInformation("ForceLastUserReducer changed last role from {OriginalRole} to User. Content: '{Content}'", 
