...
public sealed class AgentRuntimeContractTests
{
    ...
    private sealed class StubInputDefinitionProvider : IAgentInputDefinitionProvider
    {
    ...
    private sealed class StubModelRequirementAnalyzer : IAgentDefinitionModelRequirementAnalyzer
    {
