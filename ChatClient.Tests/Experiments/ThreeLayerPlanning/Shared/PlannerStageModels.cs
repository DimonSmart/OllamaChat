...
public sealed class ExperimentJsonGenerationResult<T>
{
...
public sealed class PlannerStageResult<T>
{
...
public sealed class PlannerContractException : InvalidOperationException
{
